...
from model.util import count_parameters as count
from model.util import convert2cpu as cpu
from model.util import predict_transform
...
#
#dn = Darknet('cfg/yolov3-tiny.cfg')
#dn.load_weights("yolov3-tiny.weights")
#inp = get_test_input()
#a, interms = dn(inp)
#dn.eval()
